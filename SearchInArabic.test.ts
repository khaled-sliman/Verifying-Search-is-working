...
test('SearchInArabic', async ({ page }) => {
    ...
    //Here i will type 'سويت شيرت' word in the search field (I used Xpath and placeholder as locator (Not the best practice here anyway))
    await page.fill('//input[@placeholder="Search products, brands and categories"]', 'سويت شيرت');
